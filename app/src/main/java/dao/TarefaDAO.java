...
/**
 * Created by edu_v on 09/04/2017.
 */
...
public class TarefaDAO {
    ...
    public Tarefa criarTarefa(Cursor cursor){
        Tarefa model = new Tarefa(
                ...
                cursor.getString(cursor.getColumnIndex(DatabaseHelper.Tarefas.DT_COMPLETADA))
        );
        return model;
    }
   ...
   ;
        ...
        if (model.get_id() != null){
            return database.update(DatabaseHelper.Tarefas.TABELA, valores,
